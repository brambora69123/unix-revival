...
$jobidNormal = "RENDER_GEAR_" . substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 10);
$jobNormal = new Roblox\Grid\Rcc\Job($jobidNormal, 60);



$scriptTextNormal = file_get_contents('./luascripts/gear.lua') . " return start(\"" . $id . "\",\"" . "http://unixfr.xyz" . "\");";
...
sendLog("A gear with the id " . $id . " was rendered!", "render");
