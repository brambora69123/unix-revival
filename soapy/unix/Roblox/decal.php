...
$jobidNormal = "RENDER_DECAL_" . substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 10);
...
$scriptTextNormal = file_get_contents('./luascripts/decal.lua') . " return start(\"" . $id . "\",\"" . "http://unixfr.xyz" . "\");";
