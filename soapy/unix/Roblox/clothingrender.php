...
$jobidNormal = "RENDER_CLOTHING_" . substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 10);
...
$scriptTextNormal = file_get_contents('./luascripts/clothing_render.lua') . " return start(\"" . $id . "\",\"" . "http://unixfr.xyz" . "\");";
...
sendLog("A clothing asset with the id ".$id." was rendered!","render");
?>
