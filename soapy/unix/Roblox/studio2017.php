...
$id = "TEAMCREATE_" . substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 10);
...
$scriptText = file_get_contents('team./luascripts/gameserver2017.lua') . " start(\"" . $_GET['id'] . "\",\"" . $porty . "\",\"http://" . $domain . "\",\"" . $Results['creatorid'] . "\", '" . $isR15 . "');";
...
echo ($jobResult);
sendLog("A server with the jobid of " . $job . " was opened!", "newjob");
exit();
