...
pcall(function() game:GetService("FriendService"):SetMakeFriendUrl(url .. "/game/CreateFriend?firstUserId=%d&secondUserId=%d") end)
pcall(function() game:GetService("FriendService"):SetCreateFriendRequestUrl(url .. "/game/CreateFriend?firstUserId=%d&secondUserId=%d") end)
pcall(function() game:GetService("FriendService"):SetDeleteFriendRequestUrl(url .. "/game/CreateFriend?firstUserId=%d&secondUserId=%d") end)
pcall(function() game:GetService("FriendService"):SetEnabled(true) end)
...
if placeId~=nil and url~=nil then
	...
	-- load the game
	game:Load("https://unixfr.xyz/asset/?id=" .. placeId)
...
pcall(function() game:HttpGet("http://unixfr.xyz/soapy/unix/Roblox/gameclose?job=".. game.JobId) end)
