...
function start(assetid, baseurl, custom)
local assetUrl, baseUrl, fileExtension, x, y, R6RigUrl, customUrl = "http://unixfr.xyz/asset/?id="..assetid,baseurl,"PNG",840,840,"http://unixfr.xyz/asset/?id=1785197",custom
