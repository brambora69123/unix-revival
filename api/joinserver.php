...
$serverId= $_GET['serverId'] ?? die(header('Location: '. $baseUrl .'/'));
...
$gameargs = "1+launchmode:play+gameinfo:".$base64Token."+placelauncherurl:https://unixfr.xyz/game/PlaceLauncher.ashx?request=RequestGame&placeId=".$GameId."&token=".$token."&jobid=".$serverId;
